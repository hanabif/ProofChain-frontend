        ...
        <div className="p-8 lg:p-12 overflow-y-auto max-h-[calc(100vh-88px)]">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12">
            <div className="space-y-2">
              ...
              <p className="text-[#ffffff40] font-body text-sm max-w-xl">
                Track all licensing payments and blockchain transactions across the ProofChain network.
              </p>
            </div>
          ...
          <div className="bg-[#161622]/40 border border-[#ffffff05] rounded-[40px] overflow-hidden shadow-2xl relative mb-12">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-white/[0.03]">
                    <th className="py-8 px-10 text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold">Buyer Name</th>
                    <th className="py-8 px-6 text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold">Asset Type</th>
                    <th className="py-8 px-6 text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold">Amount</th>
                    <th className="py-8 px-6 text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold">Date</th>
                    <th className="py-8 px-10 text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold text-center">Status</th>
                  </tr>
                </thead>
            ...
            <div className="p-8 border-t border-white/[0.03] flex flex-col md:flex-row items-center justify-between gap-6">
              <span className="text-[10px] font-body text-[#ffffff20] tracking-wider uppercase">
                Showing 1 to 5 of <span className="text-white font-bold italic">284 transactions</span>
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 mb-12">
            <div className="bg-[#161622]/40 border border-[#ffffff05] rounded-[40px] p-10 relative overflow-hidden group shadow-xl">
              <div className="relative z-10 flex items-end justify-between">
                <div className="space-y-3">
                  <span className="text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold">Volume Overview</span>
                  <div className="flex items-baseline gap-3">
                    <h2 className="text-4xl font-bold font-header text-white italic">1,284.50</h2>
                    <span className="text-sm font-header text-[#ffffff30] italic">ETH</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  <div className="w-32 h-12 relative opacity-50">
                    ...
                    <svg className="w-full h-full" viewBox="0 0 100 40" fill="none">
                      <path d="M0 35 Q 25 25 50 30 T 100 0" stroke="#00ff95" strokeWidth="3" fill="none" />
                    </svg>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#161622]/40 border border-[#ffffff05] rounded-[40px] p-10 relative overflow-hidden group shadow-xl">
              <div className="relative z-10 flex items-end justify-between">
                <div className="space-y-3">
                  <span className="text-[10px] font-header tracking-[0.2em] text-[#ffffff20] uppercase font-bold">Active Licenses</span>
                  <div className="flex items-baseline gap-3">
                    <h2 className="text-4xl font-bold font-header text-white italic">42</h2>
                    <span className="text-sm font-header text-[#ffffff30] italic font-body lowercase tracking-tight">Items</span>
                  </div>
                </div>
